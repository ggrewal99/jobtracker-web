...
export default function Stats({ jobCounts, totalJobs }) {
	...
	return (
		<>
			...
			<dl className='mx-auto grid grid-cols-1 gap-px bg-gray-900/5 sm:grid-cols-3 lg:grid-cols-5'>
				{Object.keys(jobCounts).length === 0 ? (
					...
					<>
						...
						>
							...
							<dd className='w-full flex-none text-3xl font-bold tracking-tight text-gray-900'>
								{totalJobs}
							</dd>
						</div>
					</>
